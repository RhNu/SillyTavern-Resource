import { getImageGenerationStore, useImageGenerationStore } from '@/ImgGenHelper/config/store';
import HelpMarker from '@/ImgGenHelper/features/settings-panel/view/components/HelpMarker';
import { HELP_TEXT, PROMPT_TEMPLATE_GUIDE } from '@/ImgGenHelper/features/settings-panel/view/meta';
