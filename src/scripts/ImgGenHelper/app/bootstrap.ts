import { probeAllPluginBackends } from '@/ImgGenHelper/adapters/ai/plugin-backend-probe';
...
export function bootstrapImageGenerationHelperV2() {
  ...
  try {
    ...
    // 探测 NekoJS / NovelAI Bridge 后端插件, 供设置面板“生成后端”选项展示可用状态
    void probeAllPluginBackends();
