import { SCRIPT_DISPLAY_NAME, SETTINGS_PANEL_IDS } from '@/ImgGenHelper/app/ids';
import SettingsPanel from '@/ImgGenHelper/features/settings-panel/view/SettingsPanel';
import '@/ImgGenHelper/features/settings-panel/view/panel.css';
import { showErrorToast } from '@/ImgGenHelper/shared/toast';
