...
export default function ImageGenerationTab() {
  ...
  const modelText = backendModelOptions.find(option => option.value === config.image.model)?.text ?? config.image.model;
  const isPluginBackend = config.image.backend === 'plugin-nekojs' || config.image.backend === 'plugin-novelai';
