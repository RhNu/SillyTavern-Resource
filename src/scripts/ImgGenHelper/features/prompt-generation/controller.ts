import { IMGGEN_BLOCK_STATE_UPDATED_EVENT } from '@/ImgGenHelper/app/ids';
import { BUILTIN_PROMPT_GENERATION_MESSAGES, type MessageEntry } from '@/ImgGenHelper/config/defaults';
...
import { generateImageBlocks, queueAutomaticImageBlocks } from '@/ImgGenHelper/features/image-generation/controller';
import { buildImgGenRef, hasImgGenRefs, stripImgGenBlocks } from '@/ImgGenHelper/features/image-generation/ref-codec';
import {
...
} from '@/ImgGenHelper/features/prompt-generation/protocol';
import { buildResolvedPromptTemplate } from '@/ImgGenHelper/features/prompt-generation/template-resolver';
import type { TaskResultToast } from '@/ImgGenHelper/features/tasking/task-events';
import type { TaskProjection as TaskCenter } from '@/ImgGenHelper/features/tasking/task-projection';
import {
  TaskStageGuard,
  TaskStageTimeoutError,
  type TaskStagePartial,
} from '@/ImgGenHelper/features/tasking/task-stage';
import { logError, logInfo, logWarn } from '@/ImgGenHelper/shared/log';
import { applyExtractTags, applyFilterTags, stripXmlComments } from '@/ImgGenHelper/shared/text';
import { showErrorToast, showInfoToast, showWarningToast } from '@/ImgGenHelper/shared/toast';
