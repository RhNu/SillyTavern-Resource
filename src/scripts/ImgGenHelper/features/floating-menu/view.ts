import { FLOATING_MENU_IDS } from '@/ImgGenHelper/app/ids';
import { getImageGenerationStore } from '@/ImgGenHelper/config/store';
import '@/ImgGenHelper/features/floating-menu/view.css';
import {
  getTaskGroupProgress,
  getTaskStatusLabel,
  pickFocusGroup,
} from '@/ImgGenHelper/features/tasking/task-progress';
import type { TaskGroup, TaskProjection } from '@/ImgGenHelper/features/tasking/task-projection';
