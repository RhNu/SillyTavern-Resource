import { buildImgGenRefFilterRegexString } from '../core/blocks';
import { IMGGEN_BLOCK_STATE_UPDATED_EVENT, REGEX_NAME } from '../core/constants';
import { logError, logWarn } from '../core/log';
import { normalizeImgGenMessageBlockState, setImgGenBlocksInMessageVariables } from '../core/message-state';
import { getImageGenerationStore, subscribeImageGenerationStore } from '../core/store';
import type { TaskCenter, TaskGroupFocus, TaskResultToast } from '../core/task-center';
import { showInfoToast, showWarningToast } from '../core/toast';
import { createImageGenerationMessageUi, type RenderBlockState } from './message-ui';
import { buildFinalImagePrompt } from './prompt';
import {
  buildAutoGenerationQueueToastMessage,
  hasAutoGenerationQueueWork,
  type AutoGenerationQueueSnapshot,
} from './queue-state';
import { requestImageGeneration } from './request';
import { getResolvedImgGenMessageState } from './resolved-state';
